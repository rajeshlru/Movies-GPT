...
const WatchPage = () => {
  ...
  return (
    <div className="">
      <div className="w-[100%] md:w-full min-h-screen bg-black text-white flex flex-col">
        <div className="flex flex-col md:flex-row">
          ...
          <div className=" w-[80%] md:w-[30%]  bg-black px-5 py-48 md:py-12  flex flex-col gap-4">
            {movieDetails && (
              <>
                <Link to="/Browse" className=" -mt-40 md:-mt-6 ml-16 md:ml-44">
